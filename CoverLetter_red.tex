...
\begin{center}			
			...
			\put(0,-13){\includegraphics[width=0.13\textwidth]{zzu_red_2.pdf}} %{zzu_blue_3.pdf}}
			...
			\put(382,-5){\includegraphics[width=0.25\textwidth]{zzu_red_3.pdf}} %{zzu_blue_4.pdf}}
			\put(0,-20){{\color{zzured}\rule{\textwidth}{1.8pt}}}
			\end{picture}
		\end{center}	  
} % footer for pages 2 on
%\lfoot{\footnotesize {\textit{Letter from \Who{} regarding ...}}} % Left footer
\cfoot{ {\color{zzured}\rule{\textwidth}{1.8pt}} No.100 Science Avenue, Zhengzhou City, Henan Province P.R.China \\ \Fax } % Change for center footer
